...
(function (can) {
  can.Model.Cacheable('CMS.Models.Directive', {
    ...
    model: function (params) {
      ...
      if (!params.selfLink && params.type !== 'Directive') {
        return CMS.Models[params.type].model(params);
      } else if (CMS.Models.Contract.meta_kinds.indexOf(params.kind) > -1) {
  ...
  CMS.Models.Directive('CMS.Models.Policy', {
    ...
    is_custom_attributable: true,
    attributes: {},
    meta_kinds: ['Company Policy', 'Org Group Policy', 'Data Asset Policy',
