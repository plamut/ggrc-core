...
(function (can) {
  ...
  can.Model.Cacheable('CMS.Models.Program', {
    ...
    tree_view_options: {
      ...
      attr_list: [
        {attr_title: 'Manager', attr_name: 'owner',
  ...
  can.Model.Cacheable('CMS.Models.Event', {
    ...
    list_view_options: {
      find_params: {__include: 'revisions'}
    },
    attributes: {
      modified_by: 'CMS.Models.Person.stub'
    }
  ...
  can.Model.Cacheable('CMS.Models.Role', {
    ...
    allowed: function (operation, object_or_class) {
      var cls = typeof object_or_class === 'function' ?
        object_or_class : object_or_class.constructor;
  ...
  CMS.Models.get_stubs = function (objects) {
    return new can.Stub.List(can.map(CMS.Models.get_instances(objects),
      function (o) {
        if (!o || !o.stub) {
